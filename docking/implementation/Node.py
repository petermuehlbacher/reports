class Node( object ):
    ...
    Sample data structure:
        ...
        Node("N",[0,0,0],None,None,None,[
            Node("CA",[4,0,0],4,None,None,[
                Node("CB",[4,3,0],3,π/2,None,[
                    Node("CG",None,3,π/4,π/3,[
                        Node(…),                <-- ~R
                        Node(…)])]),
                Node("C",[4,0,2],2,π/2,None,[
                    Node("O",None,3,π,π/2,[]),
                    Node("N",None,3,π,0,[
                        Node(…),                <-- ~CA > R
                        Node(…)]                <-- ~C>{O,N}
    ...
    """
    def __init__( self, atomname, coord, dist, phi, theta, children ):
        """
        Args:
          ...
          phi(double):      bond angle between this, this.parent and
                            this.parent.parent
          theta(double):    dihedral angle between this, this.parent,
                            this.parent.parent and this.parent.parent.parent*
